...
namespace Edit{
/******************************************************************************/
#define EI_VER 51 // this needs to be increased every time a new command is added, existing one is changed, or some of engine class file formats get updated
